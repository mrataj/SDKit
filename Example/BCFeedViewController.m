...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self)
    {
         ...
         */
        NSString *item3 = @"[user id=\"42\"]Kate Cameron[/user] has\nwriten\na\nhundred miles long exam about supermassive black holes, saved it to file [document id=\"23089\"]Seminar paper.pdf[/document] and finally sent it to her professor of physics [user id=\"78\"]dr. Gregory Watson[/user].";
        
        dataSource = [[NSArray alloc] initWithObjects:item3, nil];
    }
    return self;
}
