...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self)
    {
        ...
        NSString *item2 = @"[user id=\"42\"]Kate Cameron[/user] created document [document id=\"23241\"]Example.doc[/document] and\nwith a really long delay and text because of testing\nbullshit he was doing some sent\nit to person [user id=\"22\"]Larry Brin[/user].";
