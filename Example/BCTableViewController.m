...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self)
    {
        ...
        NSString *item0 = @"[user id=\"42\"]Kate Cameron[/user] shared link [link src=\"http://www.youtube.com\"]http://www.youtube.com[/link] to person [user id=\"13\"]Johnny English[/user].";
